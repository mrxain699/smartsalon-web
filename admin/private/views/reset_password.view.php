...
<body>
<section class="vh-100" style="background-color: #E2E1DB;">
        ...
        <div class="card" style="border-radius: 1rem;" >
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              <img src="<?=ROOT?>/images/login/mensalon.jpg"
                alt="login form" class="img-fluid" style="border-radius: 0.9rem 0 0 0.9rem;" />
            </div>
            <div class="col-md-6 col-lg-7 d-flex align-items-center" style="background-color: #ffffff; border-radius: 0 1rem 1rem 0;">
              <div class="card-body p-4 p-lg-5 text-black" >
                <form method="post">
                  ...
                  <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Set new Password</h5>
                    <?php if(@$alert) echo $alert; ?>
                  <div class="form-outline mb-4">
                    <input type="password" name="password" id="form2Example17" class="form-control form-control-lg" maxlength="11" rrequired />
                    <label class="form-label" for="form2Example17">Password</label>
                  </div>
                  <div class="form-outline mb-2">
                    <input type="password" name="cpass" id="form2Example27" class="form-control form-control-lg" maxlength="11" required />
